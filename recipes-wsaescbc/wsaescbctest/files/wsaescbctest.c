...
int main (void)
{
    ...
    // set key
    printf(">>>TEST: SETTING KEY IOCTL\n");
    ret = ioctl(fd, IOCTL_SET_MODE, SET_KEY); // switch mode 
    printf(">>>TEST: SETTING KEY WRITE\n");
    ...
    // set IV
    printf(">>>TEST: SETTING IV IOCTL\n");
    ret = ioctl(fd, IOCTL_SET_MODE, SET_IV); // switch mode 
    printf(">>>TEST: SETTING IV WRITE\n");
    ...
    printf(">>>TEST: IOCTL SET MODE ENCRYPT\n");
    ret = ioctl(fd, IOCTL_SET_MODE, ENCRYPT); // switch mode 
    printf(">>>TEST: ENCRYPT WRITE 1\n");
    ...
    printf(">>>TEST: CHECKING ENCRPTED DATA\n");
